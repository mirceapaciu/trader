...
class BacktesterSettings:
    ...
    def from_env(cls) -> "BacktesterSettings":
        return cls(
            ...
            max_position_usd=_float_env("MAX_POSITION_SIZE", _float_env("BACKTESTER_MAX_POSITION_USD", 3000.0)),
            max_positions=_int_env("MAX_POSITIONS", 5),
            max_portfolio_exposure_usd=_float_env(
                "MAX_PORTFOLIO_EXPOSURE",
                _float_env("BACKTESTER_MAX_PORTFOLIO_EXPOSURE_USD", 10000.0),
            ),
            ...
            llm_max_tokens_per_run=_int_env("BACKTESTER_LLM_MAX_TOKENS_PER_RUN", 5000000),
