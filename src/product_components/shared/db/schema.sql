...
CREATE INDEX IF NOT EXISTS ix_instruments_aliases_gin
    ON shared.t_instruments USING GIN (aliases);

CREATE INDEX IF NOT EXISTS ix_exchange_listings_ticker_lower
    ON shared.t_exchange_listings (lower(ticker) text_pattern_ops);
