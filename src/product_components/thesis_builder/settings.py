...
class ThesisBuilderSettings:
    ...
    story_event_check_enabled: bool
    ...
    def from_env(cls) -> "ThesisBuilderSettings":
        return cls(
            ...
            evidence_collection_max_minutes=_int_env("THESIS_BUILDER_EVIDENCE_COLLECTION_MAX_MINUTES", 1000),
            max_evidence_age_minutes=_int_env("THESIS_CARD_MAX_EVIDENCE_AGE_MINUTES", 1400),
            ...
            llm_max_output_tokens=_int_env("THESIS_BUILDER_LLM_MAX_OUTPUT_TOKENS", 3000),
            ...
            story_event_check_enabled=_bool_env("THESIS_BUILDER_STORY_EVENT_CHECK_ENABLED", True),
