...
| 260817-01 | Add real-LLM integration tests for ThesisBuilder event-taxonomy selection | new | docs/issues/issues-detail/260817-01.md |
| 260817-02 | Make the event-taxonomy database authoritative and bootstrap the complete predefined seed | new | docs/issues/issues-detail/260817-02.md |
