...
| 260716-01 | Story-assignment verification is bag-of-words; same-company/same-domain articles about different events still pass on a single generic token | new | docs/issues/issues-detail/260716-01.md |
